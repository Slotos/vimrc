...
vim.api.nvim_set_keymap('n', '[[', '', { callback = function() require'aerial'.prev_up() end })
vim.api.nvim_set_keymap('n', ']]', '', { callback = function() require'aerial'.next_up() end })

if vim.fn['pac#loaded']('telescope.nvim') and vim.fn['pac#loaded']('aerial.nvim') then
  -- Open Telescope list
